  ...
  <div>
    ...
    >
      ...
      <div v-if="modalType === 'newgame'">
        <p>
          Are you sure you want to reset this game and lose any current
          progress?
        </p>
    ...
    <Modal title="Game Over" :visible="game.ended" @close-modal="closeModal">
      ...
      <div>
        ...
        <button class="float-right mr-2" @click="leaderboard">
          Leaderboard
        </button>
      </div>
    </Modal>
      ...
      <div class="window default-window-height">
        <div class="title-bar">
          <div class="title-bar-text">
            Dope Wars: Dublin - Day {{ game.day }} of {{ game.dayLimit }}
          </div>
        ...
        <div class="window-body">
          ...
          <div class="mt-4 block">
            <div class="flex flex-row-reverse">
              <button
                class="ml-2"
                @click="displayModal('exitgame', 'Exit Game')"
              >
                Exit Game
              </button>
              <button class="ml-2" @click="displayModal('newgame', 'New Game')">
                New Game
              </button>
            </div>
          </div>
